...
function listado_producto() {
    ...
    if ( $rad_producto == 1 ) // Se busca por codigo SAP
        $where_aux = " and p.cod_prod1 = '$producto' and p.estadoactivo='C'";
    else if ( $rad_producto == 2 ) // Se busca por UPC
        $where_aux = " and cb.cod_barra = '$producto' and p.estadoactivo='C'";
    else if ( $rad_producto == 3 ) // Se busca por descripcion
        $where_aux = " and p.des_corta like '%$producto%' and p.estadoactivo='C'";
...
function listado_servicio() {
    ...
    if ( $rad_servicio == 1 ) // Se busca por codigo SAP
        $where_aux = " and p.cod_prod1 = '$servicio' and p.estadoactivo='C'";
    else if ( $rad_servicio == 2 ) // Se busca por UPC
        $where_aux = " and cb.cod_barra = '$servicio' and p.estadoactivo='C'";
    else if ( $rad_servicio == 3 ) // Se busca por descripcion
        $where_aux = " and p.des_corta like '%$servicio%' and p.estadoactivo='C'";
...
function ver_productos(){
    ...
    $query_ver ="SELECT p.id_producto,   
				...
				WHERE p.estadoactivo='C' and pp.id_proveedor = ".($id_prov + 0)." limit 0," . LIMITE_REG;
...
function listado() {
	...
	$query_SV ="SELECT distinct p.id_producto, 
				...
				WHERE p.estadoactivo='C' and prod_tipo = 'SV' 
...
function listado_ape() {
	...
	$query_SV =" SELECT distinct p.id_producto, 
				...
				AND id_local = ".get_local_usr($ses_usr_id)." 
				JOIN codbarra cb on cb.cod_prod1 = p.cod_prod1
				WHERE p.estadoactivo='C' and prod_tipo = 'PE' 
