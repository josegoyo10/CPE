...
/* aciones   */
$queryEstado="select ot.*, E.esta_nombre esta_actual, E.estadoterminal estado_terminal from ot LEFT JOIN estados E on E.id_estado=ot.id_estado where ot_id=".($id_ot+0) ;
...
// Agregamos el main
$MiTemplate->set_file("main","picking_tienda/estado2.htm");
