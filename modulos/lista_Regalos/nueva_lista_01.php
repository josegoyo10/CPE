...
include_idioma_mod( $ses_idioma, "nueva_lista_01" );
...
if($TipoClienteUnico == 2)
{
	...
	<script language="JavaScript">
		...
		location.href="nueva_lista_00.php";
	</script>
	<?php	
}
...
if (!$donde){	
	echo "<script language='JavaScript'>";		
		echo "location.href='nueva_lista_02.php?clie_rut=" . ($clie_rut+0). "&clie_tipo=p'";
	echo "</script>";
...
if ( isset($rutE) ){
	...
	// Agregamos el main
	$MiTemplate->set_file("main1","lista_Regalos/template/nueva_lista_temTitulo.html");
	$MiTemplate->set_file("main2","lista_Regalos/template/nueva_lista_temCuerpo.html");
	$MiTemplate->set_file("main3","lista_Regalos/template/nueva_lista_temBotones.html");
	$MiTemplate->set_file("main4","lista_Regalos/template/nueva_lista_botones.html");
