<?php
//$pag_ini = '../monitor_ot_sv/monitor_ot_sv_00.php';
$SIN_PER = 1;
include "../../includes/aplication_top.php";
include "activewidgets.php";

$queryDire = "SELECT id_direccion FROM os WHERE id_os = ( SELECT id_os FROM ot WHERE ot_id = $id_ot )";
$resultDire = tep_db_query($queryDire);
$resultado = tep_db_fetch_array( $resultDire );
$resultado['id_direccion'];
...
$MiTemplate->set_var("USR_NOMBRE",get_nombre_usr( $ses_usr_id ));
     ...
     $MiTemplate->set_var("estanombre",$estado);
	...
	$dirServicio = getlocalizacion($dirServ);
     ...
     $MiTemplate->set_var("dire_telefono_des",$osSelDire['dire_telefono']);
     $MiTemplate->set_var("dire_direccion_des",$osSelDire['dire_direccion']);
     $MiTemplate->set_var("dire_observacion_des",$osSelDire['dire_observacion']);
     $MiTemplate->set_var("ciudad_nombre_des",$dirServicio['ciudad']);
     $MiTemplate->set_var("depto_nombre_des",$dirServicio['departamento']);
...
// Agregamos el main
$MiTemplate->set_file("main","monitor_ot_sv/print_sumario.htm");
