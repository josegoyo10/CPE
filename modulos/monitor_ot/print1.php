...
$MiTemplate->set_unknowns("remove");
	...
	$MiTemplate->set_file("main","monitor_ot/print1.htm");
    ...
    $query = "SELECT os.id_local, esta_nombre, os_fechacotizacion, os_fechaboleta, USR_NOMBRES, USR_APELLIDOS,
					 ...
					 l.nom_local, dire_nombre, dire_direccion, dire_telefono, dire_observacion, comu_nombre,
...
//echo $query;
    ...
    $query = "SELECT cod_barra, cod_sap, osde_descripcion, osde_precio, osde_preciocosto, osde_cantidad, osde_tipoprod,osde_especificacion, osde_instalacion,
   if (osde_tipoprod='SV', '-', t.nombre) 'tipodespacho',
   if (osde_tipoprod='SV', ' - ',  if (osde_instalacion, 'SI', 'NO')) 'osde_instalacion'
   FROM os_detalle osd JOIN tipos_despacho t on t.id_tipodespacho = osd.id_tipodespacho WHERE ot_id = $id_ot";
